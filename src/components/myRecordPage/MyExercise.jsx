...
export default function MyExercise() {
  ...
  return (
    <div className='flex flex-col bg-dark-500 px-6 py-4 font-inter text-light'>
      ...
      <div className='scrollbar mt-2 flex h-[192px] flex-wrap gap-2 overflow-auto pr-3'>
        {exercises.map((exercise) => (
          <div
            key={exercise.id}
            className='mr-[13px] flex h-[42px] w-1/2 flex-[40%] gap-2 border-b-2 border-gray-400 pr-[13px]'
          >
